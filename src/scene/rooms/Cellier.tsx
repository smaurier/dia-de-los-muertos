...
// Centre and dimensions
const CX = -3.8
const CZ = 13.6
const CW = 6.4   // x∈[-7,-0.6]
const CD = 3.2   // z∈[12,15.2]

// Preserve jars: [dx on shelf, radius, height, colour]
const JARS_ROWS: [number, number, number, string][][] = [
  // bottom level — large ollas and jars
...
export function Cellier() {
  return (
    <group>
      ...
      {/* ── Grain sacks (jute, north-west corner) ── */}
      ...
      {/* ── Barrel + fruit crate (north-east corner) ── */}
      ...
      {/* ── Terracotta ollas stacked along the back wall ── */}
      ...
      {/* ── Chile ristras hanging from the ceiling ── */}
      ...
      {/* ── Garlic braid hanging near the door ── */}
      ...
      {/* ── Dried herbs (bundles upside-down, back wall) ── */}
      {[-5.8, -5.4].map((hx, hi) => (
      ...
      {/* ── Light: warm dim glow, single weak bulb ── */}
